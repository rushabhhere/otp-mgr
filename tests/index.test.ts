...
test.concurrent(
    'Test OTP Manager with default Map store',
    { timeout: 15000 },
    async () => {
...
test.concurrent(
    'Test OTP Manager with Redis store',
    { timeout: 15000 },
    async () => {
...
test.concurrent(
    'Test OTP Manager with Redis store for Valkey',
    { timeout: 15000 },
    async () => {
...
test.concurrent(
    'Test OTP Manager with Memcached store',
    { timeout: 15000 },
    async () => {
